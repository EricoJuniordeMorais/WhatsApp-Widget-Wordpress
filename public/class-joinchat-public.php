	...
	public function get_settings() {
		...
		$default_settings = array_merge(
			array(
				...
				'message_badge' => 'no',
				'message_send'  => '',
				'message_start' => __( 'Enviar Mensagem', 'creame-whatsapp-me' ),
				'position'      => 'right',
	...
	public function footer_html() {
		...
		if ( $this->show ) {
			...
			if ( $this->settings['message_text'] ) {
				$box_content = '<div class="joinchat__message"><div class="poly"></div>' . JoinChatUtil::formated_message( $this->settings['message_text'] ) . '</div>';
			}

			if ( 'no' !== $this->settings['form_text'] ) {
				$box_content .= '<div class="joinchat__form">
				
				<form name="zapform" id="zapform" action=""   onsubmit="return GEEKFORGEEKS()" method="post">
				<input
                type="hidden"
                name="utm_source"
                value="">
				...
				<div for="empresanamewhatsapp" class="icone_company"></div>
				<div style="float:right; width:85%;" >
				<input type="text" class="form-control" required id="empresanamewhatsapp" name="empresanamewhatsapp" value="" data-focus-placeholder="Ex: Polichat Soluções" placeholder="Nome da empresa:">
				</div>
				...
				<div class="form-group">
				<div class="icone_user"></div>
				<div style="float:right; width:85%;" >
				<input type="text" class="form-control" id="nomewhatsapp" required name="nomewhatsapp" value="" data-focus-placeholder="Ex: José Augusto" placeholder="Seu nome:">
				</div>
				</div>
				
				<div class="form-group">
				<div class="icone_phone"></div>
				<div style="float:right; width:85%;" >
				<input type="phone" class="form-control" id="telefonewhatsapp" required name="telefonewhatsapp" value="" data-focus-placeholder="Ex: +55 (62) 9 0000-0000" placeholder="Telefone:">
				...
				<div class="icone_mail"></div>
				<div style="float:right; width:85%;" >
				<input type="email" class="form-control" id="emailwhatsapp" required name="emailwhatsapp" value="" data-focus-placeholder="Ex: name@example.com" placeholder="E-mail:" >
				</div>
				</div>
