!(function (p, u, d) {
    ...
    function t() {
        ...
        h || (i && n && !joinchat_obj.settings.message_badge && s) || (l += " joinchat--tooltip"),
            ...
            joinchat_obj.$(".joinchat__button").on("click", function () {
                a && !joinchat_obj.chatbox ? c() : (j(), joinchat_obj.open_whatsapp());
            }),
            ...
            joinchat_obj.is_mobile &&
                (p(d).on("focus blur", "input, textarea", function (t) {
            ...
            a &&
                ...
                0 < (n = p(".joinchat_show, .joinchat_force_show")).length &&
                ((b = new IntersectionObserver(function (t) {
                    p.each(t, function () {
    ...
    (u.joinchat_obj = u.joinchat_obj || {}),
        (joinchat_obj = p.extend({ $div: null, settings: null, store: null, chatbox: !1, is_mobile: !1 }, joinchat_obj)),
        (joinchat_obj.$ = function (t) {
            return p(t || this.$div, this.$div);
        }),
        (joinchat_obj.send_event = function (o, e) {
            (o = o || ""), (e = e || "click");
            var t = u[this.settings.ga_tracker] || u.ga || u.__gaTracker;
            "function" == typeof t && "function" == typeof t.getAll
                ? (t("set", "transport", "beacon"),
                  t.getAll().forEach(function (t) {
                      t.send("event", "JoinChat", e, o);
                  }))
                : "function" == typeof gtag && gtag("event", e, { event_category: "JoinChat", event_label: o, transport_type: "beacon" }),
                "object" == typeof dataLayer && dataLayer.push({ event: "JoinChat", eventAction: e, eventLabel: o }),
                "function" == typeof fbq && fbq("trackCustom", "JoinChat", { eventAction: e, eventLabel: o });
        }),
        ...
        (joinchat_obj.chatbox_hide = function () {
            this.chatbox && ((this.chatbox = !1), this.$div.removeClass("joinchat--chatbox joinchat--tooltip"), this.settings.message_badge && this.$(".joinchat__badge").removeClass("joinchat__badge--out"), p(d).trigger("joinchat:hide"));
        }),
        (joinchat_obj.save_hash = function () {
            var t = this.settings.message_hash || "none",
                o = (this.store.getItem("joinchat_hashes") || "").split(",").filter(Boolean);
            -1 === o.indexOf(t) && (o.push(t), this.store.setItem("joinchat_hashes", o.join(",")));
        }),
        (joinchat_obj.open_whatsapp = function (t, o) {
           
            
            if(document. getElementById("telefonewhatsapp"). value. length == 0 || document. getElementById("nomewhatsapp"). value. length == 0  || document. getElementById("empresanamewhatsapp"). value. length == 0  || document. getElementById("emailwhatsapp"). value. length == 0 )
            {                
alert("É necessário preencher todos os campos.")

}else{
    (t = { link: this.whatsapp_link(t || this.settings.telephone, o || this.settings.message_send) }), (o = new RegExp("^https?://(wa.me|(api|web|chat).whatsapp.com|" + location.hostname.replace(".", ".") + ")/.*", "i"));
    p(d).trigger("joinchat:open", [t, this.settings]),
    o.test(t.link) ? (this.send_event(t.link), u.open(t.link, "joinchat", "noopener")) : console.error("Join.chat: the link doesn't seem safe, it must point to the current domain or whatsapp.com");
}
